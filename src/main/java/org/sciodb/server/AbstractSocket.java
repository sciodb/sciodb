...
public abstract class AbstractSocket implements Runnable {
    ...
    final static private Logger logger = Logger.getLogger(AbstractSocket.class);

    private Selector selector;
    private InetSocketAddress listenAddress;

    public AbstractSocket(final String address, final int port) throws IOException {
...
//        dataMapper.put(channel, new ArrayList());
    ...
    public abstract void read(final SelectionKey key);
